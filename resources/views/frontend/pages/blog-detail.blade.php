...
@section('title', 'AOAC || Blog Detail Page')
            ...
            <div class="col-lg-8 col-12">
                <div class="blog-single-main">
                    <div class="row">
                        <div class="col-12">
                            <div class="image">
                                <img src="{{ $post->photo }}" alt="{{ $post->title }}" class="responsive-img">
                            </div>
                            <div class="blog-detail">
                                ...
                                <div class="content">
                                    @if($post->quote)
                                    <blockquote>
                                        <i class="fa fa-quote-left"></i> {!! $post->quote !!}
                                    </blockquote>
                                    @endif
                        ...
                        <p class="text-center p-5">
                            You need to <a href="{{ route('login.form') }}" style="color:rgb(54, 54, 204)">Login</a> OR <a style="color:blue" href="{{ route('register.form') }}">Register</a> to comment.
                        </p>
                        @endauth
                        <div class="col-12">
                            <div class="comments">
...
<style>
    .responsive-img {
        height: 7%;
        width: 7%;
        object-fit: cover; /* This ensures the aspect ratio is preserved and the image fits within the given dimensions */
    }
</style>
